...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'cl', // 必需
      link: 'https://github.com/clozz-lin' // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'cl | <a href="https://github.com/clozz-lin/clozz-lin.github.io/blob/master/LICENSE" target="_blank">MIT License</a>' // 博客版权信息，支持a标签或换行标签</br>
    },
